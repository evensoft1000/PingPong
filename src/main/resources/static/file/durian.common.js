...
var Durian = {
	...
	loading: function(obj, options) {
			...
			var defaultVal = {
				'zIndex': '999999',
				'msg': '<img src="/admin/images/common/pre_loader2_15px.gif" align="absmiddle" />&nbsp;' + i18n('lang.durian.common.progress_and_wait:처리 중입니다. 잠시만 기다려주십시오.') + '<span class="progress" style="padding-left:10px;"></span>',
				'border': '0',
				'padding': '15px',
				'backgroundColor': '#000',
				'radius': '8px',
